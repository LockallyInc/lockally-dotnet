...
namespace Lockally.SDK.Test.Api
{
    ...
    /// </summary>
    public sealed class SignupApiTests : ApiTestsBase
    {
        private readonly ISignupApi _instance;

        public SignupApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<ISignupApi>();
        }
        ...
        {
            SignupRequest signupRequest = default!;
            var response = await _instance.SignupAsync(signupRequest);
