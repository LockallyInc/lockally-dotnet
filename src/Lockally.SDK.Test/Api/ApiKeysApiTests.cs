...
namespace Lockally.SDK.Test.Api
{
    ...
    public sealed class ApiKeysApiTests : ApiTestsBase
    {
        ...
        public async Task V1ApiKeysGetAsyncTest()
        {
            var response = await _instance.V1ApiKeysGetAsync();
            var model = response.Ok();
            Assert.IsType<V1ApiKeysGet200Response>(model);
        }

        /// <summary>
        /// Test V1ApiKeysIdDelete
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task V1ApiKeysIdDeleteAsyncTest()
        {
            Guid id = default!;
            await _instance.V1ApiKeysIdDeleteAsync(id);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task V1ApiKeysPostAsyncTest()
        {
            V1ApiKeysPostRequest v1ApiKeysPostRequest = default!;
            var response = await _instance.V1ApiKeysPostAsync(v1ApiKeysPostRequest);
            var model = response.Created();
            Assert.IsType<V1ApiKeysPost201Response>(model);
        }
    }
}
