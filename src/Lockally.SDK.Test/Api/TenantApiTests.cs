...
namespace Lockally.SDK.Test.Api
{
    ...
    public sealed class TenantApiTests : ApiTestsBase
    {
        ...
        public async Task V1TenantGetAsyncTest()
        {
            var response = await _instance.V1TenantGetAsync();
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task V1UsageGetAsyncTest()
        {
            var response = await _instance.V1UsageGetAsync();
            var model = response.Ok();
            Assert.IsType<V1UsageGet200Response>(model);
        }
    }
}
